...
?>
<html>
<head><link rel="stylesheet" href="failed.css"></head>
<body>
...
<div align="center">
	<p class="cmsg" style="color:red"> Oops!! Better luck next time</p>
	<p class="score" style="color:black">You have scored <?php $e=explode("-",$_GET['percentage']); $per = $e[0]; $c=$e[1];echo $per;?>%</p>
</div>
...
<h3 style='padding:0px 130px'>Make better result by enrolling again...</h3>
...
$sql2="select c.course_name,DATE_FORMAT(sc.start_date,'%d-%b-%Y') as start_date,DATE_FORMAT(sc.end_date,'%d-%b-%Y') as end_date,sc.assessment_status,substring_index(sc.trainer_email,'@',1) as trainer_email,sc.participant_limit from scheduled_courses sc inner join course_details c on sc.course_id=c.course_id where c.course_name like '".$c."';";
